...
<head>
    ...
    <title>Login Admin — PMR Wira 242</title>
    ...
    <style>
        *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .auth-subtitle {
            text-align: center;
            font-size: 13px;
            color: rgba(232,211,178,.5);
            margin-bottom: 28px;
        }

        .auth-divider {
            height: 1px;
            background: rgba(232,211,178,.12);
            margin-bottom: 28px;
        }
...
<body>
    ...
    <div class="auth-card">
        ...
        <p class="auth-subtitle">Masukkan kredensial untuk mengakses panel admin</p>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="form-group">
                ...
                <input id="password" class="form-input {{ $errors->has('password') ? 'is-error' : '' }}"
